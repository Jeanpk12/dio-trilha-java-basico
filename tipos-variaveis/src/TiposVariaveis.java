public class TiposVariaveis {
    public static void main(String[] args) throws Exception {
        String meuNome = "Jean"; // Tipo string armazena sequancia de caracteres
        char tipoSanguinio = 'O'; // Tipo char armazena um caracter
        int idade = 28; // Tipo int armazena número inteiro
